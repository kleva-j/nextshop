...
export default buildConfig({
  ...
  endpoints: [
    { path: '/create-payment-intent', method: 'post', handler: createPaymentIntent },
    { path: '/stripe/customers', method: 'get', handler: customersProxy },
    { path: '/stripe/products', method: 'get', handler: productsProxy },
    { path: '/seed', method: 'get', handler: seed },
  ],
  plugins: [
    stripePlugin({
    ...
    seo({ collections: ['pages', 'products'], generateTitle, uploadsCollection: 'media' }),
    payloadCloud(),
  ],
});
